...
use "${temp}/census_002_unbal", clear
* merge with match file
merge m:1 szemazon using "${temp}/matches_all"
...
replace ty_child_1 = ty_child_LB_1 if (ty_child_LB_1!=. & ty_child_1==. & tm_child_LB_1 >= ym(2022,10))
replace ty_child_2 = ty_child_LB_2 if (ty_child_LB_2!=. & ty_child_2==. & tm_child_LB_2 >= ym(2022,10))
replace ty_child_3 = ty_child_LB_3 if (ty_child_LB_3!=. & ty_child_3==. & tm_child_LB_3 >= ym(2022,10))
replace ty_child_4 = ty_child_LB_4 if (ty_child_LB_4!=. & ty_child_4==. & tm_child_LB_4 >= ym(2022,10))
replace ty_child_5 = ty_child_LB_5 if (ty_child_LB_5!=. & ty_child_5==. & tm_child_LB_5 >= ym(2022,10))
replace ty_child_6 = ty_child_LB_6 if (ty_child_LB_6!=. & ty_child_6==. & tm_child_LB_6 >= ym(2022,10))
replace ty_child_7 = ty_child_LB_7 if (ty_child_LB_7!=. & ty_child_7==. & tm_child_LB_7 >= ym(2022,10))
replace ty_child_8 = ty_child_LB_8 if (ty_child_LB_8!=. & ty_child_8==. & tm_child_LB_8 >= ym(2022,10))
replace ty_child_9 = ty_child_LB_9 if (ty_child_LB_9!=. & ty_child_9==. & tm_child_LB_9 >= ym(2022,10))
replace ty_child_10 = ty_child_LB_10 if (ty_child_LB_10!=. & ty_child_10==. & tm_child_LB_10 >= ym(2022,10))
...
rename ln_income_2018 ln_income_2018_cts 
rename U_2018 U_2018_cts 
rename hsShare_2018 hsShare_2018_cts 
rename Q_ln_income_2018 Q_ln_income_2018_cts
rename Q_U_2018 Q_U_2018_cts
rename Q_hsShare_2018 Q_hsShare_2018_cts 
rename P_ln_income_2018 P_ln_income_2018_cts
rename P_U_2018 P_U_2018_cts
rename P_hsShare_2018 P_hsShare_2018_cts 

* drop obs for speed
count
keep if inrange(ty,2014,2024)
keep szemazon ty C_childrenNEW C_children N_childrenNEW N_children CSOK_* Q_CSOK_* P_CSOK_* ///
	ty_mother_birth cohort5 marriedBy2019 kidsBy2019 lcstip eduCatg ethCatg relCatg ///
	U_2018* Q_U_2018* P_U_2018* ln_income_2018* Q_ln_income_2018* P_ln_income_2018* ///
	hsShare_2018* P_hsShare_2018* Q_hsShare_2018*  P_de01 P_de01_2018 P_SH_t_1 P_SH_t_2 P_SH_t_3 P_SH_t_4 ///
	ksh4 Q_ksh4 P_ksh4 jaras175 Q_jaras175 P_jaras175 ///  
	mover*
compress
count
* save this for regressions
save "${temp}/census_002_unbal_filled", replace